...
keywords = ["США", "Республиканская", "Демократическая"]
...
class NewsParser:
    ...
    def extract_info(self, article_url: str) -> Union[Dict[str, Any], None]:
    ...
    def main(self):
        ...
        while True:
            ...
            time.sleep(3600*4) 
      # Запуск на более короткое время для проверки работы программы
            print()
